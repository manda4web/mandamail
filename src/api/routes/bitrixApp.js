...
function getAppJsAccounts() {
  return [
    ...
    '        "<td>" + statusBadge + "</td>" +',
    '        "<td>" + lastCheck + "</td>" +',
    '        \'<td style="white-space:nowrap"><button class="btn btn-sm btn-outline btn-toggle" data-id="\' + acc.id + \'" data-active="\' + (acc.active !== false) + \'">\' + toggleLabel + \'</button> <button class="btn btn-sm btn-danger btn-delete" data-id="\' + acc.id + \'">🗑</button></td>\' +',
    '        "</tr>";',
    '    }).join("");',
    '  }).catch(function() {',
    ...
    '    mailbox: document.getElementById("acc-mailbox").value.trim() || "INBOX",',
