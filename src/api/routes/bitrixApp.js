...
function getAccountsPageHtml() {
  return [
    ...
    '  <p style="color:#6b7280;font-size:14px;margin-bottom:20px">Configure as contas de email que serão monitoradas. Cada email recebido será convertido em um deal no Bitrix24.</p>',
