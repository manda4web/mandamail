...
function getMappingPageHtml() {
  return [
    ...
    '    <p>Como os dados do email são mapeados para os campos do deal no Bitrix24.</p>',
    '    <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:16px">',
    '      <table style="width:100%;font-size:13px">',
    '        <thead><tr><th style="text-align:left;padding:8px;color:#6b7280">Campo do Email</th><th style="text-align:left;padding:8px;color:#6b7280">→</th><th style="text-align:left;padding:8px;color:#6b7280">Campo no Bitrix24</th></tr></thead>',
    '        <tbody>',
    '          <tr><td style="padding:8px">Assunto</td><td style="padding:8px">→</td><td style="padding:8px"><strong>Título do Deal</strong></td></tr>',
    '          <tr><td style="padding:8px">Remetente (email)</td><td style="padding:8px">→</td><td style="padding:8px"><strong>Contato vinculado</strong></td></tr>',
    '          <tr><td style="padding:8px">Remetente (nome)</td><td style="padding:8px">→</td><td style="padding:8px"><strong>Nome do Contato</strong></td></tr>',
    '          <tr><td style="padding:8px">Corpo do email</td><td style="padding:8px">→</td><td style="padding:8px"><strong>Atividade de Email + Comentário</strong></td></tr>',
    '          <tr><td style="padding:8px">Reply-To</td><td style="padding:8px">→</td><td style="padding:8px"><strong>Comentário na Timeline</strong></td></tr>',
    '          <tr><td style="padding:8px">Anexos</td><td style="padding:8px">→</td><td style="padding:8px"><strong>Arquivos na Timeline</strong></td></tr>',
    '        </tbody>',
    '      </table>',
    '    </div>',
    '  </div>',
...
function getAppJsPlanAndUtils() {
  return [
    ...
    '          if (t && t.bitrix_category_id) pipelineSelect.value = t.bitrix_category_id;',
    '          loadStages(pipelineSelect.value);',
    '          if (t && t.bitrix_responsible_id) responsibleSelect.value = t.bitrix_responsible_id;',
    '        }).catch(function() {});',
    '      }',
    '    });',
    '',
    '    // Load users (try department.get or fallback to current user)',
    '    BX24.callMethod("user.search", { ACTIVE: true, UF_DEPARTMENT: "%" }, function(result) {',
    '      if (result.error()) {',
    '        // Fallback: just get current user',
    ...
    '          }',
    '          var u = r2.data();',
    '          responsibleSelect.innerHTML = \'<option value="\' + u.ID + \'">\' + escHtml(u.NAME + " " + u.LAST_NAME) + " (eu)</option>";',
    '        });',
    '        return;',
    '      }',
